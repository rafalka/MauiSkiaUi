...
- **Per-control docs (NFR-5):** [docs/controls/](docs/controls/README.md) — one `.md` per public control/layout (how it works / how to use). MAUI reimplementations link to official docs and document SkiaUi differences only.
